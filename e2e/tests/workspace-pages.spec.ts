...
test.describe("paginas internas", () => {
  ...
  test("dashboard renderiza resumos e navega para secoes principais", async ({ page }) => {
    await page.goto("/app");
  ...
  test("chat envia, edita, exclui, busca e lida com lista vazia", async ({ page, browser }) => {
  ...
  test("progresso publica atualizacao e cobre estado sem projetos", async ({ page, browser }) => {
  ...
  test("feedback valida botao desabilitado, envia avaliacao e cobre lista vazia", async ({ page, browser }) => {
  ...
  test("perfil edita dados e exibe historico academico", async ({ page }) => {
  ...
  test("documentos alterna tipo, envia, remove e cobre estado vazio", async ({ page, browser }) => {
  ...
  test("notificacoes marca como lida, filtra e limpa vista local", async ({ page }) => {
  ...
  test("configuracoes salva, valida senha, alterna tema e faz logout", async ({ page }) => {
