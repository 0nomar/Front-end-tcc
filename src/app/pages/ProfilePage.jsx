      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 justify-between mb-5">
              ...
              {!editing ? (
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                  <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-1.5 px-3 py-2 border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50 transition-colors"
                  ...
                  <button
                    onClick={handleSave}
                    disabled={loading}
                    className="w-full sm:w-auto flex items-center justify-center gap-1.5 px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors"
                    style={{ fontSize: "0.8rem", fontWeight: 500 }}
                  >
                    {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            ...
            <div className="space-y-4">
              {applications.map((app) => {
                ...
                return (
                  <div key={app.id} className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 p-4 bg-gray-50 rounded-xl">
